	...
	//	drawObjects: () => void;
		...
		constructor() {
			...
			this.pauseModal = new bootstrap.Modal(document.getElementById('pauseModal') as HTMLElement);
			this.endgameModal = new bootstrap.Modal(document.getElementById('endgameModal') as HTMLElement);
